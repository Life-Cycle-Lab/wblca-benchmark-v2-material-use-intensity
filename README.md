# Analysis and Projection of Material Use and Embodied Carbon for New Construction Buildings in North America
A codebase and analyzed dataset of material use and embodied carbon intensity for new construction buildings in North America. This repository and its accompanying publications are the results of joint collaboration between Carbon Leadership Forum (CLF) and Life Cycle Lab (LCL) through their Whole Building Life Cycle Assessment (WBLCA) Benchmarking V2 study in 2025. This work investigates material use intensity (MUI) and embodied carbon intensity (ECI) in 243 North American buildings using WBLCA models. A special use case of the analysis is also showcased where material use and embodied carbon within US's new construction buildings are projected towards 2050 in a business as usual scenario. Results are published alongside open-source code and a public dashboard for exploring MUI and ECI across building typologies, structural systems, and materials. Also included in this repository are codes and data used to build the dashboard with [Plotly Dash](https://dash.plotly.com/) – a Python framework for interactive web applications.
...
- [**Code & Data**](https://github.com/Life-Cycle-Lab/wblca-benchmark-v2-material-use-embodied-carbon-intensity)
  ...
  - **Data Descriptor Article**: [Benke et al. *A Harmonized Dataset of High-resolution Whole Building Life Cycle Assessment Results in North America.*](https://www.nature.com/articles/s41597-025-05216-0)  
...
Image Exports/
   ├── Fig.1.Metadata.png
   ├── Fig.2.BoxPlots.png
   ├── Fig.3.BarCharts_sorted_by_mean_eci.png
   ├── Fig.4.MaterialBoxplotsECIorder.png
   ├── Fig.5.mat_group_mat_type_combined.png
   ├── Fig.6.Projections_by_building_use_eci_order.png
   ├── Fig.7.Projections_by_mat_group_eci_order.png
   ├── Fig.S1.projects-mui.png
   ├── Fig.S2.projects-eci.png
   ├── Fig.S3.Sankey.png
   └── (Additional figures generated by the analysis notebooks)

Input Data/
   ├── buildings_metadata_02-21-2025.xlsx
   ├── full_lca_results_02-21-2025.xlsx
   └── floor_area_projections_2025-02-25.xlsx

Output Data/
   ├── carbon_stock_projection_by_building_use_type.csv
   ├── mat_group_to_type_stats_df_mui_eci.xlsx
   ├── mat_type_to_mat_group_mapping.csv
   ├── material_carbon_intensity_results.csv
   ├── material_carbon_intensity_results_single_family.csv
   ├── material_carbon_intensity_results_single_family_table.csv
   ├── material_carbon_intensity_results_table.csv
   ├── material_carbon_intensity_results_table_with_single_family_estimate.csv
   ├── material_carbon_intensity_results_table_with_single_family_estimate_list.csv
   ├── material_stock_projection_by_building_use_type.csv
...
├── material_use_embodied_carbon_projection.ipynb  # Projection analysis of material/carbon stock and intensity
...
- **Projections**:
  - Uses floor area growth assumptions by primary building use to estimate future material stock and embodied carbon stock
  - Computes projected material stock and carbon stock by building use type
  - Saves tabular projections to `Output Data/` and projection figures to `Image Exports/`
- **Dashboard Options**:
...
### 4. Run the projection notebook

- Open `material_use_embodied_carbon_projection.ipynb` in Jupyter and run all cells.
- Required inputs in `Input Data/`:
  - `full_lca_results_02-21-2025.xlsx`
  - `buildings_metadata_02-21-2025.xlsx`
  - `floor_area_projections_2025-02-25.xlsx`
- Outputs are written to `Output Data/`, including:
  - `material_stock_projection_by_building_use_type.csv`
  - `carbon_stock_projection_by_building_use_type.csv`
- Projection figures are saved to `Image Exports/`, including `Fig.6.Projections_by_building_use_eci_order.png` and `Fig.7.Projections_by_mat_group_eci_order.png`.
